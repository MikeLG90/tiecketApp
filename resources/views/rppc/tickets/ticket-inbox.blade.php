<x-base-layout :scrollspy="false">
   ...
   <div class="row layout-top-spacing" >
      <div class="col-xl-12 col-lg-12 col-md-12" id="inbox" style="display: yes;">
         <div class="row">
                  ...
                  <div class="tab-title">
                     <div class="row">
                        <div class="col-md-12 col-sm-12 col-12 text-center mail-btn-container">
                           <a class="btn btn-danger" onclick="toggleDivs()">
                              ...
                              <ul class="nav nav-pills d-block" id="pills-tab" role="tablist">
                                 <li class="nav-item">
                                    <a class="nav-link list-actions active" id="mailInbox">
                                       ...
                                       <span class="nav-names">Buzón</span> <span class="mail-badge badge"></span>
                                    </a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="nav-link list-actions" id="important">
                                       ...
                                       <span class="nav-names">Tickets resueltos</span>
                                    </a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="nav-link list-actions" id="draft">
                                       ...
                                       <span class="nav-names">Tickets pendientes</span> <span class="mail-badge badge"></span>
                                    </a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="nav-link list-actions" id="sentmail">
                                       ...
                                       <span class="nav-names"> Tickets enviados</span>
                                    </a>
                                 </li>
                                 <li class="nav-item">
      ...
      <!-- Form -->
      <div id="tck-form" class="col-lg-12 layout-spacing" style="display: none;">
            ...
            @csrf
                   ...
                   <div class="row">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="mb-4 mail-cc">
                                           ...
                                           <div>
                                              <select name="estado" id="m-cc" class="form-control">
                                                 <option value="" disabled selected>Seleccione un tipo</option>
                                                 <option value="tipo1">Nuevo</option>
                                                 <option value="tipo2">En curso (Asignada)</option>
                                                 <option value="tipo2">En curso (Planificada)</option>
                                                 <option value="tipo2">En espera</option>
                                                 <option value="tipo2">Resuelto</option>
                                                 <option value="tipo2">Cerrado</option>
                                                 <!-- Agrega más opciones según sea necesario -->
                                              </select>
                                              <span class="validation-text"></span>
                                           </div>
                                     ...
                                     <div class="w-100">
                                     <p for="exampleFormControlTextarea1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-notebook-pen"><path d="M13.4 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7.4"/><path d="M2 6h4"/><path d="M2 10h4"/><path d="M2 14h4"/><path d="M2 18h4"/><path d="M21.378 5.626a1 1 0 1 0-3.004-3.004l-5.01 5.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z"/></svg> Descripción</p>
                     ...
                     <button class="btn btn-danger mb-4" onclick="toggleDivs()" type="button">Cancelar</button>
                  </div>
                            </form>
            </div>
         </div>
...
function handleSubmit(event) {
    ...
    // Aquí puedes realizar cambios de divs
    toggleDivs();
...
function toggleDivs() {
    ...
    const div2 = document.getElementById('tck-form');
