...
.button-group button:disabled {
            ...
            <div class="widget-content widget-content-area">
               <table class="multi-table table dt-table-hover" style="width:100%">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="button-group" role="group" aria-label="Basic example">
                              <button data-bs-toggle="modal" data-bs-target="#exampleModalCenter2{{ $d->oficina_id }}" type="button" >
                              ...
                              <button data-bs-toggle="modal" data-bs-target="#exampleModalCenter3{{ $d->oficina_id }}" type="button" >
                     ...
                     @include('rppc.delegaciones.edit')
                     @include('rppc.delegaciones.delete')
                     @php $i++; @endphp
                     @endforeach
                  </tbody>
                  <tfoot>
   ...
   <div class="modal-content">
      <div class="modal-header">
         <h5 class="modal-title" id="exampleModalCenterTitle">Nueva delegación</h5>
      ...
      <div class="modal-body">
         <h4 class="modal-heading mb-4 mt-2">Porfavor ingrese el nombre de la nueva delegación</h4>
         <div class="row mb-4">
            ...
            <select class="form-select" aria-label="Default select example" id="dependencia" name="dependencia">
