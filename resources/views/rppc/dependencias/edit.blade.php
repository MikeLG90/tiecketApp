<div class="modal fade" id="exampleModalCenter2{{ $d->dep_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalCenterTitle">Editar dependencia</h5>
...
<div class="form-group mb-4">
    <form method="POST" action="/editar-dependencia/{{ $d->dep_id }}">
    @csrf
    @method('PUT')
<input type="hidden" value="{{ $d->oficina_id }}">
<label for="disabledTextInput">Nombre del área</label>
<input type="text" name="nombreedit" id="nombre" class="form-control" value="{{ $d->nombre }}" placeholder="Nombre">
</div>
<label for="basic-url" class="form-label">Descripción</label>
            <div class="input-group mb-3">
            <input type="text" name="descripcionedit" id="nombre" class="form-control" value="{{ $d->descripcion }}" placeholder="Nombre">            
            </div>
</div>
