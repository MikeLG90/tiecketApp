<div class="modal fade" id="exampleModalCenter2{{ $d->oficina_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="form-group mb-4">
    <form method="POST" action="/editar-delegacion/{{ $d->oficina_id }}">
    @csrf
    @method('PUT')
<input type="hidden" value="{{ $d->oficina_id }}">
<label for="disabledTextInput">Nombre del área</label>
<input type="text" name="nombreedit" id="nombre" class="form-control" value="{{ $d->oficina }}" placeholder="Nombre">
</div>
</div>
