            ...
            <div class="widget-content widget-content-area">
               <table class="multi-table table dt-table-hover" style="width:100%">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="button-group" role="group" aria-label="Basic example">
                              <button data-bs-toggle="modal" data-bs-target="#exampleModalCenter2{{ $o->oficina_folio_id }}" type="button" >
                              ...
                              <button data-bs-toggle="modal" data-bs-target="#exampleModalCenter3{{ $o->oficina_folio_id }}" type="button" >
                     ...
                     @include('rppc.oficinafolio.editar-oficina-folio')
                     @include('rppc.oficinafolio.eliminar-oficina')
                     @php $i++; @endphp
                     @endforeach
                  </tbody>
                  <tfoot>
      ...
      <div class="modal-body">
         ...
         <div class="row mb-4">
            <div class="form-group mb-4">
               <form method="POST" action="{{ route('store-oficina-folio') }}">
                  @csrf
                  <label for="disabledTextInput">Nombre de la oficina</label>
                  <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
            </div>
            <label for="basic-url" class="form-label">Descripción</label>
            <div class="input-group mb-3">
            <input type="text" name="descripcion" id="nombre" class="form-control" placeholder="Descripción">            
            </div>
